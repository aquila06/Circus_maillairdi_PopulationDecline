...
It contains:
* a .RData file with the necessary objects to run the models and to create the figures included in the MS, as well as the different models that have been run.
